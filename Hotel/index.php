			...
			<nav class="navbar navbar-default">
				<div class="navbar-header navbar-left">
					<button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#bs-example-navbar-collapse-1">
						...
						<span class="icon-bar"></span>
						<span class="icon-bar"></span>
					</button><!--SUN <span>RISE</span>-->
					<h1><a class="navbar-brand" href="index.php">	  <h2 style=color:white;>GRNDhotel</h2><p class="logo_w3l_agile_caption">Your Dreamy Resort</p></a></h1>
				</div>
				...
				<ul class="cbp-ig-grid">
					<li>
						<div class="w3_grid_effect">
							...
							<span class="cbp-ig-category">GRND HOTEL</span>
						</div>
					</li>
					<li>
						<div class="w3_grid_effect">
 	...
 	<div class="about-wthree" id="about">
		  <div class="container">
				   <div class="ab-w3l-spa">
                            <h3 class="title-w3-agileits title-black-wthree">About Our GRND HOTEL</h3> 
...
<section class="contact-w3ls" id="contact">
	<div class="container">
		...
		<div class="col-lg-6 col-md-6 col-sm-6 contact-w3-agile1" data-aos="flip-right">
			...
			<p class="contact-agile1"><strong>Email :</strong> <a href="mailto:name@example.com">INFO@GRNDHOTEL.COM</a></p>
			<p class="contact-agile1"><strong>Address :</strong> 5 miles from the downtown Al-Dahar district</p>
