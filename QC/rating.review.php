...
<div class="register-form">
    ...
    <form action="" method="POST">
        ...
        <input id="user" type="text" name="FirstName" placeholder="name" />
        </p>

        <p>
        <label>Email: </label>
        <input id="IDNUM" type="text" name="Email" placeholder="email" />
        </p>
       ...
       <label>Age </label>
        <input id="user" type="text" name="Age" placeholder="age" />
        </p>
