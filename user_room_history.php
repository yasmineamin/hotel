...
include_once("functions.php");
	...
	<table style="width: 100%;">
		<tr >
			<td id="td1" style="padding: 10px; font-size: 48px;	position: fixed;">THE <p style="color: #e6b800; display: inline;">DELUXE</p> HOTEL</td>
			<td id="td1" style="font-size: 25px; text-align: right;	position: fixed;">Hello, <?php echo $row[2]; ?></td>
		</tr>
	</table>
	<ul>
