...
?>
	<div id="navbar" class="home-body-nav">
		<a id="logout" href="home.php"><i class="fa fa-chevron-left" aria-hidden="true"></i>&nbsp;Back</a>
	...
	<div class="hotel-image">
		 <div class='three'>
		<div class='hotel-image-detail'><img class='img' src='' alt='Image Error'  width='350px' height='200px'>  
    ...
    <div class='hotel-image-detail'><img class='images.jpg' src='picture/superior.jpg' alt='Image Error' width='350px' height='200px'>
     <form method='POST' action="rbooking.php" >
	...
	<div class='three'>
    <div class='hotel-image-detail'><img class='images (1).jpg' src='picture/family.jpg' alt='Image Error' width='350px' height='200px'>
         <form method='POST' action="rbooking.php" >
